...
void test_CryostatID_normal()
{
  ...
  struct Config {
    readout::fhicl::CryostatID Cryo{fhicl::Name("Cryo")};
  };
...
void test_TPCsetID_normal()
{
  ...
  struct Config {
    readout::fhicl::TPCsetID TPCset{fhicl::Name("TPCset")};
  };
...
void test_OptionalTPCsetID_omitted()
{
  ...
  std::optional<ID_t> const id = geo::fhicl::readOptionalID(validatedConfig.TPCset);
  BOOST_TEST(id.has_value() == expectedID.has_value());
  if (expectedID.has_value()) {
    BOOST_TEST(id->isValid == expectedID->isValid);
    if (expectedID->isValid) BOOST_TEST(id.value() == expectedID.value());
...
void test_OptionalROPID_present()
{
  ...
  using ID_t = readout::ROPID;
  struct Config {
    readout::fhicl::OptionalROPID ROP{fhicl::Name("ROP")};
  };
...
void test_OptionalROPID_omitted()
{
  ...
  std::optional<ID_t> const id = geo::fhicl::readOptionalID(validatedConfig.ROP);
  BOOST_TEST(id.has_value() == expectedID.has_value());
  if (expectedID.has_value()) {
    BOOST_TEST(id->isValid == expectedID->isValid);
    if (expectedID->isValid) BOOST_TEST(id.value() == expectedID.value());
...
void test_ROPIDsequence_normal()
{
  ...
  std::string const configStr{"ROPs: [ { C:0 S:1 R:1 }, { C:2 S:3 R:0 } ]"};
...
void test_ROPUnifiedInterface()
{
  ...
  std::string const configStr{"ROP:       { C:1 S:5 R:0 }"
  ...
  std::vector<ID_t> const default6({ID_t{1U, 5U, 6U}, ID_t{1U, 5U, 7U}, ID_t{1U, 5U, 8U}});
  ...
  default3value = default3;
  auto id23 = geo::fhicl::readParameter(config().MaybeROP, std::move(default3));
  ...
  default6value = default6;
  auto id53 = geo::fhicl::readParameter(config().MaybeROPs, std::move(default6value));
  ...
  default6value = default6;
  auto id63 = geo::fhicl::readParameter(config().NoROPs, std::move(default6value));
